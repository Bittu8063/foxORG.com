function setActiveCarouselItem(card){
 ...
 if (isBuilder) {
     $(document).on('add.cards', function(event) {
         ...
         $(event.target).find('.carousel-item [fxr-media]').on('click', function(e) {
             clickHandler(e);
         });
         $(event.target).on('slide.bs.carousel', function() {
             $(event.target).find('.carousel-item .clonedCol [fxr-media]').off('click').on('click', function(e) {
                         clickHandler(e);
                     });
         });
